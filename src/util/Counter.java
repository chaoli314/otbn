...
/**
 * Created by chaoli on 11/1/16.
 * Replace int with BigInteger to avoid overflow.
 */
...
public class Counter implements Comparable<Counter> {
    ...
    private BigInteger count = BigInteger.ZERO;         // current value
 ...
 ******************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t < trials; t++) {
            hits[new java.util.Random().nextInt(n)].increment();
        }
